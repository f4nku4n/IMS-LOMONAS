"""
Source code for Interleaved Multi-start Scheme Non-dominated Sorting Genetic Algorithm III (IMS-NSGA3)
...
class IMS_NSGA3(IMS_NSGA2):
    ...
    def _solve(self, problem, max_eval, **kwargs):
        ...
        self.sampling, self.crossover, self.mutation = get_genetic_operator(crx_prob=1.0, crx_eta=30,
        ...
        LOP_name.append(f'NSGA3 #{id_worker - 1} (pop size = {pop_size})')
        isKilled = [False]
        ...
        while True:
            if n_iter == self.base ** hat:
                ...
                new_processor = self.initialize_processor(pop_size=pop_size, ref_dirs=ref_dirs,
    ...
    def initialize_processor(self, pop_size, **kwargs):
        processor = NSGA3(pop_size=pop_size, ref_dirs=kwargs['ref_dirs'],
